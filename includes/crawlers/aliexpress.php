...
class KilikMarketAliexpressCrawler {
  ...
  public $websites = [
    1 => [
      ...
      "custom" => TRUE,
      "data" => [
        "categories_base_url" => "https://www.aliexpress.com/all-wholesale-products.html?spm=a2g0o.productlist.16005.1.264a443f7Z7m5y",
  ...
  public function get_products($categories, $try = 1) {
    ...
    foreach($categories as &$category) {
      // sleep(5);
      $crawler = $this->client->request('GET', "https://www.aliexpress.com/category/100003109/women-clothing.html");
      ...
      // echo $crawler->html();
      // exit;
      $crawler->filter('.list-items')->each(function ($node) {
        var_dump($node);
